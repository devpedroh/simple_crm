...
export default {
    ...
    methods: {
        validate: function (e) {
            ...
            if (this.$refs.form.validate()) {
                this.$http.put('/api/dashboard/suppliers/update/' + this.$route.params.id, {
                    ...
                    if (response.data.cod === 200) {
                        ...
                        setTimeout(() => {
                            this.$router.push({ name: 'DashboardSuppliers' })
                        }, 2200)
    ...
    created() {
        ...
        this.$http.get('/api/dashboard/suppliers/view/' + this.$route.params.id, {
            'headers': {
