...
export default {
    ...
    methods: {
        validate: function (e) {
            ...
            if (this.$refs.form.validate()) {
                this.$http.put('/api/dashboard/products/update/' + this.$route.params.id, {
    ...
    created() {
        ...
        this.$http.get('/api/dashboard/products/view/' + this.$route.params.id, {
            'headers': {
                Authorization: 'Bearer ' + this.$store.getters['AuthUser/getToken']
            }
        }).then(response => {
            if (response.data.cod === 200) {
                ...
                this.inputs.price.text = data.price
                this.inputs.weight.text = data.weight
                this.inputs.weight_unit_id.text = data.weight_unit_id
                this.inputs.width.text = data.width
                this.inputs.width_unit_id.text = data.width_unit_id
                this.inputs.length.text = data.length
                this.inputs.length_unit_id.text = data.length_unit_id
